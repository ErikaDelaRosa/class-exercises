...
window.setTimeout(() => {
   alert("hola")}
    ,1000);
// Non-blocking code
// Promise always goes on capital letters
//we have to store the declaration of promise and message in the same page
...
// Promises  are the best solution if you want to do something will take a long time to be done and you don't want your app wait for it to be done, so it will work on the background, like downloading and image or a video from another server.
